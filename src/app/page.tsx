      ...
      <section className="mt-5 mb-10 bg-slate-300 dark:bg-white dark:bg-opacity-20 dark:backdrop-blur-md shadow-lg">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md sm:text-center">
            ...
            <p className="mx-auto mb-8 max-w-2xl font-light text-black dark:text-white md:mb-12 sm:text-xl">Stay up to date with the Latest and Newly posted jobs feel free to sign up with your email.</p>
            <form action="#">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                ...
                <div>
                  <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg bg-indigo-300 border cursor-pointer bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Subscribe</button>
                </div>
              </div>
            </form>
          </div>
